...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const scriptURL = 'https://script.google.com/macros/s/AKfycbwsltMWOp_MZmsTJRq7175iwiZ4RMuLh2Ae2v06xZBYCrCOC8hHKW6TTID0LMHf8V7u/exec';
  ...
  form.addEventListener('submit', function(e) {
    ...
    .then(data => {
      if (data.success) {
        ...
        // Save to localStorage to persist the thank you message on page refresh
        localStorage.setItem('biblePreauthEmail', email);
