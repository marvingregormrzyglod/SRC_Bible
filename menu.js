...
const leviticusGroups = [
  ...
  { name: "🍁 WARNINGS", start: 26, end: 27, class: "warnings", subtitles: "Blessings • Curses" }
];
...
const numbersGroups = [
  ...
  { name: "🌲 BATTLES", start: 22, end: 31, class: "battles", subtitles: "Balaam • Midian" },
...
const deuteronomyGroups = [
  ...
  { name: "🌾 LAW", start: 5, end: 26, class: "law", subtitles: "10 Commandments • Rules" },
  { name: "🌲 WARNING", start: 27, end: 30, class: "warning", subtitles: "Blessings & Curses" },
  { name: "🍁 HANDOFF", start: 31, end: 34, class: "handoff", subtitles: "Joshua • Moses’ death" }
];
...
const johnGroups = [
  ...
  { name: "🌲 LOVE", start: 13, end: 17, class: "holiness", subtitles: "Footwashing • New Command • Vine" },
  { name: "🍁 GLORY", start: 18, end: 21, class: "redemption", subtitles: "Cross • Resurrection • 'Feed My Sheep'" }
];

const psalmsGroups = [
  { name: "🍂 LAMENT", start: 1, end: 41, class: "oppression", subtitles: "Cries • Trust • Messianic Hints" },
  { name: "🌾 DELIVERANCE", start: 42, end: 89, class: "handoff", subtitles: "Exile • Temple • God’s Faithfulness" },
